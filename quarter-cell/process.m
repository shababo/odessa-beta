...
if strcmp(handles.defaults.AO0,'ch1_out')==1 
    ...
    switch clamp_mode
        case 1
            thissweep(:,1)=thissweep(:,1)*1000;
        case 2
            thissweep(:,1)=thissweep(:,1)*50;
        case 3
            thissweep(:,1)=thissweep(:,1)*1000;
    end
end
if strcmp(handles.defaults.AO1,'ch2_out')==1
    ...
    switch clamp_mode
        case 1
            thissweep(:,2)=thissweep(:,2)*1000;
        case 2
            thissweep(:,2)=thissweep(:,2)*50;
        case 3
            thissweep(:,2)=thissweep(:,2)*1000;
    end
end
...
handles.data.trial_metadata(sweep_counter).stim_key = [];
