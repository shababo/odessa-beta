function [phase_masks,stim_key,pockels_ratio_refs_multi] = ...
    build_multi_loc_phases_w_combos(multitarg_locs,num_stim,single_spot_locs,targs_per_stim,...
